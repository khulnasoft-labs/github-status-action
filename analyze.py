...
# Also see https://github.com/khulnasoft-lab/github-status-action/issues/52
...
def gen_report_preamble():
    ...
    attr_link = (
        "[khulnasoft-lab/github-status-action](https://github.com/khulnasoft-lab/github-status-action)"
    )
    MD_REPORT.write(
        textwrap.dedent(
            f"""
...
def analyse_view_clones_ts_fragments() -> pd.DataFrame:
    ...
    for p in csvpaths:
        ...
        # https://github.com/khulnasoft-lab/github-status-action/issues/4
        df = df.fillna(0)
