...
# GHRS: GitHub Repo Stats https://github.com/khulnasoft-lab/github-status-action
...
cat << EOF > README.md
## github-status-action for ${STATS_REPOSPEC}

- statistics for repository https://github.com/${STATS_REPOSPEC}
- managed by GitHub Action: https://github.com/khulnasoft-lab/github-status-action
